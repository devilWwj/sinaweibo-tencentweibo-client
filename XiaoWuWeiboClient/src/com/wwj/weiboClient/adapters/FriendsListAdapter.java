 ...
 * 
 */
public class FriendsListAdapter extends BaseAdapter implements Const {
	...
	public FriendsListAdapter(Activity context, List<JSONObject> tencentUsers,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		case TENCENT:
			...
			try {
				...
				viewHolder.description.setText(userObj
						.getString("location"));
